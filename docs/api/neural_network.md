...
Помимо архитектур было реализовано [ансамблирование](ensemble.md) моделей, при котором существует возможность использование всех моделей разом. Более того в архитектурах моделей используются адаптивная функция активации [Siren](#siren) и оптимизированная функция [GeLU](#gelu).
